...
def main():
    ...
    parser.add_argument('--dlatent_dir', default='latents', help='Directory for storing dlatent representations')
    ...
    tflib.init_tf()
    if args.models == 'url':
        with dnnlib.util.open_url('https://drive.google.com/uc?id=1MEGjdvVpUsu1jB4zrXZN7Y4kBBOzizDQ',
